 ...
 * @version
 */
public class TC_ShortTerm extends TaxBase implements TaxCounter {
...
//		AnnualTax_Type[] delinquent = tb.filterDelinquent(inDelinquent, calDelinquent);
		...
		//计算本年度纳税信息对象
		AnnualTax_Type currentTax = tb.getCurrentTax(carInfo, taxInfo, taxStartDate, insureEndDate, Tax_Type_Code.DQ_VOUCHER);
		if("E".equals(taxInfo.getTaxConditionCode())){
