...
public class DataSourceUtil {  
    ...
    static {  
        ...
        try {  
            //java应用  
            //String confile = DataSourceUtil.class.getClassLoader().getResource("").getPath().replaceAll("%20"," ")+"/" + confile;  
        	confile = DataSourceUtil.class.getClassLoader().getResource("/").getPath().replaceAll("%20"," ") + confile; 
