 ...
 * @描述：SYJK_CCS_CCSBGCXRCJB（车船税变更查询入参表） VO
 * */
public class SYJK_CCS_CCSBGCXRCJB implements Serializable{
	...
	private String CERTICODE = null; 				//	车主证件号码  
	private String CREDENTIALCODE = null; 			//	车主证件类型
	private String ADDRESS = null; 					//	车主地址
	private String PHONENO = null; 					//	车主联系电话
	...
	private Date INSUREENDDATE = null;			 	//	投保始期
	private Date INSURESTARTDATE = null; 			//	投保止期
